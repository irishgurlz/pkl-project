...
if (isset($_POST['update'])){
    ...
    if($result){
        ...
        "
          <script>
             window.location.href='../kategori/kelola_kategori.php';
          </script>
        ";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><a href="../kategori/kelola_kategori.php" style="font-size:20px;"> < kembali </a></h1>
                    <h1 class="h3 mb-4 text-gray-800">EDIT TYPE KATEGORI</h1>

                    <form action="edit_type_kategori2.php" method="POST">
                    <div class="row">
